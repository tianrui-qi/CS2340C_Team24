...
This document introduces the main features of WanderSync and the design of each
feature.
To implement these features, Firebase Realtime Database is used to store
all the data. 
More specifically, the application utilizes five databases:
...
Project, *CS 2340 Objects and Design* by Prof. 
[Nimisha Roy](https://www.linkedin.com/in/nimisha-roy-csegatech/), 
